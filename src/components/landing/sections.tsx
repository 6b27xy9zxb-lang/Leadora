...
export function HeroSection() {
  return (
    <section id="top" className="min-h-screen flex flex-col relative" style={{ overflowX: "clip" }}>
      <NavBar />

      <div className="shrink-0 relative z-10 mt-16 sm:mt-20 md:mt-24 pointer-events-none">
        <FadeIn delay={0.15} y={40}>
          <h1 className="hero-heading font-black uppercase tracking-tight leading-[0.95] w-full text-center px-3 text-[7.4vw] sm:text-[7.8vw] md:text-[8.2vw] lg:text-[8.6vw]">
            <span className="block whitespace-nowrap">Find Businesses.</span>
            <span className="block whitespace-nowrap">Build Websites.</span>
            <span className="block whitespace-nowrap">Win More Clients.</span>
          </h1>
        </FadeIn>
      </div>
      ...
      <div className="mt-auto flex justify-between items-end gap-4 px-6 md:px-10 pt-24 sm:pt-28 pb-7 sm:pb-8 md:pb-10 relative z-20">
...
const AUDIENCES = [
  ...
  },
  {
    ...
    desc: "Pair Leadora's AI prompts with any no-code website builder to ship pages before the call ends.",
  },
  {
    icon: GraduationCap,
...
const TEAM = [
  ...
  { name: "Piyush S. Meharwade", role: "Co-Founder", email: "piyushmeharwade@gmail.com", linkedin: "https://www.linkedin.com/in/piyush-meharwade-46546733a", website: undefined as string | undefined },
];
...
export function TeamSection() {
  return (
    <section id="contact" className="bg-ls-surface relative z-10 px-5 sm:px-8 md:px-10 py-20 sm:py-24 md:py-32">
      ...
      <div className="max-w-6xl mx-auto mt-12 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        {TEAM.map((leader, i) => (
